            ...
            <div class="row">
		  	...
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href="workspace.php"><i class="glyphicon glyphicon-pencil"></i> Ideation &nbsp&nbsp&nbsp&nbsp&nbsp&nbspContest</a></li>
            ...
            <div class="col-md-10">
			  	<div class="col-md-6">
			  		<div class="short-div">
	  					<div class="content-box-large">
			  				<div class="panel-heading">
								<div class="panel-title">Contests</div>
	  				...
	  				<div class="short-div">
	  					<div class="content-box-large">
			  				<div class="panel-heading">
								<div class="panel-title">Team for Ideation Contest</div>
			  	...
			  	<div class="col-md-6">
			  			<div class="content-box-large">
			  				<div class="panel-heading">
								<div class="panel-title">Ideation Contest</div>
