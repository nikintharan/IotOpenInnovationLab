  ...
  <body>
    ...
    <section id="about" class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="section-title wow fadeInUp" data-wow-delay="0s">IoT Open Innovation Lab</h2>
              ...
              <div class="col-md-4 col-sm-6">
                <div class="service-block wow fadeInDown" data-wow-delay="0.2s">
                  <div class="img-wrap">
                    <img src="assets/img/feature/img-2.jpg" alt="">
                  </div>
                  <div class="descr">
                    <h4>Plan</h4>
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.  Aenean commodo ligula eget dolor.  Aenean massa.  Cum sociis natoque </p>
              ...
              <div class="col-md-4 col-sm-6">
                <div class="service-block wow fadeInDown" data-wow-delay="0.3s">
                  <div class="img-wrap">
                    <img src="assets/img/feature/img-3.jpg" alt="">
                  </div>
                  <div class="descr">
                    <h4>Benefits</h4>
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.  Aenean commodo ligula eget dolor.  Aenean massa.  Cum sociis natoque </p>
